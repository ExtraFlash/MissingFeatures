...
def get_results_for_dataset(dataset_name):
    ...
    dae_categorical_name = ModelFactory.DAE_Dynamic_TYPE_LIGHTNING_NAME

    input_size = X_train.shape[1]

    checkpoint_path = f"../../../optimized_models/{dataset_name}/{dae_categorical_name}/{dae_categorical_name}.ckpt"

    model, loaded = ModelFactory.get_model(dae_categorical_name, input_size, checkpoint_dir=checkpoint_path,
