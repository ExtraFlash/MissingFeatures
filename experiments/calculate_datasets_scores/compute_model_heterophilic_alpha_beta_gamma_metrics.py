...
def main():
    ...
    for dp in data_percentages:
        ...
        beta_out  = f"model_heterophilic_beta_values_data_percentage_{dp}.csv"
        gamma_out = f"model_heterophilic_gamma_values_data_percentage_{dp}.csv"
        theta_out = f"model_heterophilic_theta_values_data_percentage_{dp}.csv"
