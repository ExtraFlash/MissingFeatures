...
def main():
    ...
    ap.add_argument("--out", default="statistical_tests_heterophilic.png", help="Optional path to save the combined figure")
    args = ap.parse_args()

    dp = args.dp
    alpha_path = args.alpha_csv or f"model_dataset_heterophilic_alpha_values_data_percentage_{dp}.csv"
    gamma_path = args.gamma_csv or f"model_dataset_heterophilic_gamma_values_data_percentage_{dp}.csv"
    ...
    fig.suptitle(f"P-values only (dp={dp}), heterophilic", y=0.98)
