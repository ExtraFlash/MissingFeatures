...
def main():
    ...
    for dp in data_percentages:
        ...
        beta_out_csv  = f"dataset_heterophilic_beta_values_data_percentage_{dp}.csv"
        gamma_out_csv = f"dataset_heterophilic_gamma_values_data_percentage_{dp}.csv"
        eta_out_csv   = f"dataset_heterophilic_eta_values_data_percentage_{dp}.csv"
