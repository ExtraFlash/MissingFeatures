...
if __name__ == '__main__':
    ...
    models_names = ModelFactory.RANDOM_FOREST_MODELS_NAMES  # Make sure num_features was first
    models_type = 'random_forest'
    ...
    plt.savefig(f"{metric}_heterophilic_data_{models_type}.png", bbox_inches='tight', dpi=300)
