...
def draw_merged_panel(ax, results, model_type, datasets_homophility, xlim,
    ...
    ax.set_xlabel("Beta (sensitivity to k)")
    ax.set_ylabel("Model")
    ax.set_xlim(xlim)
...
def main():
    parser = argparse.ArgumentParser(description="Merged per-model beta boxplots (100%) as 1x2 grid.")
    ...
    parser.add_argument("--out", default="model_dataset_beta_values_boxplots_100.png",
