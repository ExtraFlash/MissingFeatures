...
def main():
    ...
    for dp in data_percentages:
        ...
        beta_out_csv = f"model_dataset_beta_values_data_percentage_{dp}.csv"
        beta_mat.to_csv(beta_out_csv, index=True)
        print(f"[OK] Wrote {beta_out_csv}")

        gamma_out_csv = f"model_dataset_gamma_values_data_percentage_{dp}.csv"
        gamma_mat.to_csv(gamma_out_csv, index=True)
        print(f"[OK] Wrote {gamma_out_csv}")

        alpha_out_csv = f"model_dataset_alpha_values_data_percentage_{dp}.csv"
