...
def save_results_for_dataset(dataset_name: str, is_multy_class: bool, types_list,
    ...
    for df, results, i in enumerate(zip([results_with_dae_df, results_without_dae_df, results_only_dae_df], [results_with_dae_dict, results_without_dae_dict, results_only_dae_dict])):
        for model_name in MODELS_NAMES:
