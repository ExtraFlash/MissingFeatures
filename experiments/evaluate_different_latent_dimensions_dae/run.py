...
def save_results_for_dataset():
    ...
    for cv in range(cvs):
        ...
        for latent_dim in latent_dimensions:
            auc_results, accuracy_results = get_model_results(model_name, X_train, y_train, X_val, y_val, latent_dim=latent_dim)
...
def get_model_results(model_name: str, X_train, y_train, X_val, y_val, latent_dim=None):
